...
function focusPlusContext(data) {
    ...
    var yScale = d3.scaleLinear([0, height2]);
    ...
    var navYScale = d3.scaleLinear([0, height2]);
     ...
     */
    xAxis.domain(xScale,yScale);
    yAxis.domain(xScale,yScale);
    
    navXAxis.domain(navXScale,navYScale);
